...
from rest_framework.permissions import IsAuthenticated # use IsAuthenticatedOrReadOnly to allow viewing to unauthenticated users
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
        ...
        def perform_create(self, serializer):
            """Sets the user profile to authenticated user"""
